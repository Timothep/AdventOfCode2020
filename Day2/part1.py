...
for passwordEntry in data:
    minOccurence = passwordEntry[0]
    maxOccurence = passwordEntry[1]
    letter = passwordEntry[2]
    password = passwordEntry[3]
    if int(minOccurence) <= password.count(letter) and password.count(letter) <= int(maxOccurence):
        count = count + 1
