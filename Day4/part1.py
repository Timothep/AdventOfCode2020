...
def containsAllFields(password):
    if not password.__contains__("byr"):
        return False
    if not password.__contains__("iyr"):
        return False
    if not password.__contains__("eyr"):
        return False
    if not password.__contains__("hgt"):
        return False
    if not password.__contains__("hcl"):
        return False
    if not password.__contains__("ecl"):
        return False
    if not password.__contains__("pid"):
        return False
    
    # If we reached this, it can be missing
    #if not password.__contains__("cid"):
    #    return False
